...
function expandSeeds(difficulty, seeds) {
    const expanded = seeds.flatMap((seed, seedIndex) => variants.map((variant, variantIndex) => ({
...
export function getRandomPuzzle(difficulty, recentPuzzleIds = []) {
